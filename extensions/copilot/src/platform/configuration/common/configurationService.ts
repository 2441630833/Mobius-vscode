	...
	*/
	...
	export namespace Advanced {
		...
		*/
		...
		export const WorkspaceEnableCodeSearch = defineAndMigrateExpSetting<boolean>('chat.advanced.workspace.enableCodeSearch', 'chat.workspace.enableCodeSearch', false);

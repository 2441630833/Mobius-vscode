...
// Mobius: ByokUtilityModelNotificationContribution / GitHubMcpContrib intentionally not registered.
...
export const vscodeNodeContributions: IExtensionContributionFactory[] = [
	...vscodeContributions,
	// Mobius: mount copilot_* languageModelTools FIRST — before ConversationFeature/auth.
	// Otherwise activate() can stall and tools stay data-only ("no implementation registered").
	...
	// Mobius: Continue is default; suppress Copilot BYOK utility-model nag and GitHub MCP
	// (issues/PRs MCP). Local languageModelTools (copilot_readFile, …) stay via ToolsContribution.
	...
	// ToolsContribution is registered at the top of this list for Mobius.
...
export const vscodeNodeChatContributions: IExtensionContributionFactory[] = [
	...
	// ToolsContribution moved to vscodeNodeContributions for Mobius eager tool mount.

...
function isMobiusIde(): boolean {
  return vscode.env.appName === "Mobius" || vscode.env.uriScheme === "mobius";
}
...
export function setupStatusBar(
  ...
  // Mobius uses the chat panel — hide tab-autocomplete status chrome in the status bar.
  if (isMobiusIde()) {
    statusBarItem?.hide();
    return;
  }

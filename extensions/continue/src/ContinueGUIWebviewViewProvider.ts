  ...
  implements vscode.WebviewViewProvider
{
  ...
  getSidebarContent(
    ...
    <html lang="en">
      ...
      <body>
        <div id="root">
          <div id="continue-loading" style="display:flex;align-items:center;justify-content:center;height:100%;color:var(--vscode-descriptionForeground, #888);font-family:var(--vscode-font-family, sans-serif);font-size:13px;">
            Loading Agent…
          </div>
        </div>

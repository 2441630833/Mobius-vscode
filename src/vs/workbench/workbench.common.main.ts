...
// Chat
// Mobius: Continue workbench integration (incl. continueChat.css) must load in the main IDE, not only Agents.
import './contrib/continue/browser/continue.contribution.js';

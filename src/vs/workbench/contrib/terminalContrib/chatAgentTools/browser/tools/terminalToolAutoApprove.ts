...
export function isSessionAutoApproveLevel(
	...
	// Mobius Agent mode: always auto-approve terminal commands (matches Continue sidebar).
	if (isMobiusAgentSessionAutoApproved(chatSessionResource, chatWidgetService, chatService, chatRequestId)) {
		return true;
	}

...
suite('PromptFilesLocator', () => {
	...
	suite('skills', () => {
		suite('findAgentSkills', () => {
			...
			testT('finds auto-generated skills nested under the auto subfolder', async () => {
				setLocations({
					'.agents/skills': true,
					// disable other defaults
					'.github/skills': false,
				...
				await mockFiles(fileService, [
					{
						path: '/Users/legomushroom/repos/vscode/.agents/skills/auto/hermes-style-skill/SKILL.md',
						contents: ['---', 'name: hermes-style-skill', 'description: Use when ...', '---'],
					},
					{
						path: '/Users/legomushroom/repos/vscode/.agents/skills/auto/another-generated/SKILL.md',
						contents: ['# Another Generated Skill'],
					},
					{
						path: '/Users/legomushroom/repos/vscode/.agents/skills/manual-skill/SKILL.md',
						contents: ['# Manual Skill'],
					},
				]);
				const locator = instantiationService.createInstance(PromptFilesLocator);
				...
				assertOutcome(
					skills.map(s => s.uri),
					[
						'/Users/legomushroom/repos/vscode/.agents/skills/auto/hermes-style-skill/SKILL.md',
						'/Users/legomushroom/repos/vscode/.agents/skills/auto/another-generated/SKILL.md',
						'/Users/legomushroom/repos/vscode/.agents/skills/manual-skill/SKILL.md',
					],
					'Must find skills nested under auto/ (self-evolving) as well as top-level manual skills.',
				);
			});

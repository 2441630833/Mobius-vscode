...
import { ICustomViewDescriptor, IViewContainersRegistry, IViewsRegistry, ViewContainer, ViewContainerLocation, Extensions as ViewExtensions } from '../../../common/views.js';
...
/** Built-in Continue extension id (vscode/extensions/continue). */
const CONTINUE_EXTENSION_ID = new ExtensionIdentifier('Continue.continue');
...
// Mobius: Continue is embedded in the Copilot/Chat auxiliary bar slot (core-registered webview).
const continueChatViewDescriptor: ICustomViewDescriptor = {
	type: 'webview',
	id: ChatViewId,
	containerIcon: chatViewContainer.icon,
	containerTitle: chatViewContainer.title.value,
	singleViewPaneContainerTitle: chatViewContainer.title.value,
	name: localize2('continue.viewContainer.label', "Continue"),
	...
	originalContainerId: ChatViewContainerId,
};
Registry.as<IViewsRegistry>(ViewExtensions.ViewsRegistry).registerViews([continueChatViewDescriptor], chatViewContainer);

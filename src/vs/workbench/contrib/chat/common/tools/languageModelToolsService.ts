...
export interface ILanguageModelToolsService {
	...
	/**
	 * Whether a contributed tool has a live implementation (vscode.lm.registerTool).
	 * Tool *data* from package.json can exist without an implementation until the
	 * extension finishes activating — do not treat getTool() alone as "ready".
	 */

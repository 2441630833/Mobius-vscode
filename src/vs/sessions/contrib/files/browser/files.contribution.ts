...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'workbench.action.agentSessions.openFilesView',
			title: localize2('openFilesView', "Files"),
			icon: Codicon.files,
			f1: true,
	...
	async run(accessor: ServicesAccessor) {
		...
		await viewsService.openViewContainer(SESSIONS_FILES_CONTAINER_ID, true);
	}
});

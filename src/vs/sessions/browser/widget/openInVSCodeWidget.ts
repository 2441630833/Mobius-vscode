...
export class OpenInVSCodeTitleBarWidget extends BaseActionViewItem {
	...
	override render(container: HTMLElement): void {
		...
		const hoverText = this.keybindingService.appendKeybinding(localize('openInVSCodeHover', "Open in {0} Editor Window", this.productService.nameShort), this.keybindingCommandId);

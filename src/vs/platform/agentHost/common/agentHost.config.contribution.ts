...
/** Mobius uses Continue instead of the built-in Copilot agent host. */
const isContinueBasedIde = product.defaultChatAgent?.extensionId === 'Continue.continue';
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		[AgentHostEnabledSettingId]: {
			...
			default: !isWeb && product.quality !== 'stable' && !isContinueBasedIde,

...
import { shouldDefaultToAgentsWindow } from '../../platform/product/common/mobiusAgentsStartup.js';
...
export class CodeApplication extends Disposable {
	...
	private async openFirstWindow(accessor: ServicesAccessor, initialProtocolUrls: IInitialProtocolUrls | undefined): Promise<ICodeWindow[]> {
		...
		// Handle agents window first (explicit --agents, or Mobius default when no paths).
		if (args['agents'] || shouldDefaultToAgentsWindow(args, this.productService.defaultChatAgent?.extensionId)) {
